...
public class ParamStringManager {
   public static final String PARAM_CONFIG_NAME = "pages";
   public static final String PARAM_PATH_PAGE_INDEX = "path.page.index";
   public static final String PARAM_MESSAGES_NAME = "messages";
