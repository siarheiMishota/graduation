...
public class SqlQueryUserDao {
   ...
   public static final String SELECT_ALL_ADULTS = "SELECT id, passport_id, date_birth, login, password, email, first_name, surname, father_name, gender, confirmed, role, activation_code FROM users where date_birth  <DATE_ADD(CURDATE(), INTERVAL -18 YEAR )";
   ...
   public static final String DELETE_BY_LOGIN="delete from users where login=?";
