...
import static by.mishota.graduation.resource.FilePath.PATH_PAGE_FORGOTTEN_PASSWORD;

public class ForgottenPasswordGetCommand implements ActionCommand {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        return new Router(PagePathManager.getProperty(PATH_PAGE_FORGOTTEN_PASSWORD));
    }
}
