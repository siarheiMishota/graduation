...
import static by.mishota.graduation.resource.FilePath.PATH_PAGE_ADMIN_VIEW_ALL_NEWS;
import static java.lang.Math.ceil;

public class ViewAllNewsGetCommand implements ActionCommand {
    ...
    public ViewAllNewsGetCommand(NewsService newsService) {
        this.newsService = newsService;
    }

    @Override
    public Router execute(HttpServletRequest request) {
        Router router = new Router(PagePathManager.getProperty(PATH_PAGE_ADMIN_VIEW_ALL_NEWS));
        ...
        if (user == null) {
            ...
            session.setAttribute(ATTRIBUTE_REFERER, CONTROLLER_ADMIN_VIEW_ALL_NEWS_GET);
