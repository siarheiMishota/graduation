...
public class MainCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        ResourceBundle resourceBundle=ResourceBundle.getBundle(MAIN_COMMAND_FILE_NAME_PROPERTIES,request.getLocale());
        ...
        try {
            ...
            request.setAttribute(INTERNAL_SERVER_ERROR, resourceBundle.getString(SERVER_UNAVAILABLE));
